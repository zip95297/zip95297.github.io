...
class NoteSelector:
    ...
    def draw_tree(self, stdscr):
        ...
        header = "笔记更新工具 - 使用↑↓键导航，Enter键选择，Space展开/折叠，q退出，u更新"
        ...
        while True:
            ...
            if key == curses.KEY_UP:
                ...
                if self.note_path:
                    # 退出curses模式以执行命令
                    curses.endwin()
                    cmd = f"/Users/zip95297/Repository/BLOG/zjb-blog/utils/update_cli -n \"{self.note_path}\""                                        
                    print(f"执行命令: {cmd}")
                    try:
                        # 执行命令
...
def main():
    if len(sys.argv) > 1:
        ...
        base_dir = "/Users/zip95297/Repository/BLOG/zjb-blog/source/_posts"
